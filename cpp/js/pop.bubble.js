POP.Bubble = function(speed) {
    ...
    this.speed = speed || POP.rnd(5, 1) * - 0.05;
    this.remove = false;
    this.counter = 0;
    ...
    this.move = function() {
        ...
        this.y = this.y+this.waveSize* 0.25*Math.cos(0.5*this.counter)+this.speed;
        this.x = this.waveSize * 2 * Math.sin(this.counter) + this.xConstant;
